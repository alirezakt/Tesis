...
def get_parser():
    ...
    is_new_version: bool
        use new version of neibouring graphs
    """
    ...
    parser.add_argument('--test_set', default='atl0807', type=str,
                        help='Set this value to [atl0801, atl0802, atl0803, atl0804, atl0805, atl0806, atl0807] for different test set')
    ...
    parser.add_argument('--is_new_version', default=False, type=ast.literal_eval)
    parser.add_argument('--gwo_transformer_layers', default=2, type=int)
    parser.add_argument('--gwo_attention_head', default=8, type=int)
    parser.add_argument('--gwo_lstm_layers', default=32, type=int)
    parser.add_argument('--gwo_dropout_rate', default=0.1, type=float)
    parser.add_argument('--gwo_weight_decay', default=0, type=float)
    parser.add_argument('--gwo_scheduler_gamma', default=1, type=float)
    parser.add_argument('--gwo_clip', default=1, type=float)
    parser.add_argument('--useLSTM', default=True, type=ast.literal_eval)
